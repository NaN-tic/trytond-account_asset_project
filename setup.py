...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:NaN-tic/trytond-account_asset_project',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_asset_project'
    },
    classifiers=[
